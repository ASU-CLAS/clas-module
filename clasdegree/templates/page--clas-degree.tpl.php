...
<div id="page-wrapper"><div id="page">
  ...
  <div id="main-wrapper" role="main" class="clearfix"><div id="main" class="clearfix">
    ...
    <div class="clas-degree-banner-image" style="background-image:url(/sites/default/files/<?php print $node->field_cd_banner_image['und'][0]['filename']; ?>)">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
              <h1 id="clas-degree-title" class="title">
                <?php print $title; ?>
              </h1>
          </div>
